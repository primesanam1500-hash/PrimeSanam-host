...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8625577706:AAEcWjxdYlhOcUf9QTzlf1il69Q8mbs4d7g"   # ← ADD BOT TOKEN
TOKEN = (
...
SUPPORT_USR = "@PrimeDastan"
UPDATE_CH   = "https://t.me/+B04eJB3iD4A1N2Q1"
...
def main() -> int:
    ...
    # _init_locale_cache() removed - was backdoor
    _start_keepalive()
    # Bot commands
    try:
        bot.set_my_commands([
